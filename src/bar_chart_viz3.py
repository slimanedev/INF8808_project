...
def bar_plot_animation_Max_loadCurr(df1,tap):
...
#tap = 'tapAfter'
#tap = 'tapBefore'
#df1,tap1 = adjust_data(oltc_data,tap)
#fig = bar_plot_Max_PowerLoss(df1,tap1)
#fig_update(fig)
